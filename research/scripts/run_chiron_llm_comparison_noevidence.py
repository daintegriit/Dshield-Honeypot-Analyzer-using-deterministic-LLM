...
"""
====================================================================
CHIRON — GOVERNED vs NO-EVIDENCE BASELINE LLM BENCHMARK
====================================================================
...
1) Governed deterministic Chiron reasoning
vs
2) Raw unconstrained LLM reasoning WITHOUT deterministic evidence

This benchmark evaluates whether governance:

- reduces hallucinations
- reduces unsupported escalation
- reduces speculative cyber reasoning
- improves operational boundedness
- improves deterministic grounding
- reduces token cost
- stabilizes analyst-grade narration
- improves deterministic operational fidelity
- reduces analyst narrative drift

IMPORTANT
---------
BASELINE MODELS DO NOT RECEIVE:
...
This is a TRUE governance comparison benchmark.

ELITE BENCHMARK FEATURES
------------------------
- warmup tracking
- model-batched execution
- latency normalization
- governance refusal tracking
- token accounting
...
- warmup exclusion from latency averages
